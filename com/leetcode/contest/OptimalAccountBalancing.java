...
public class OptimalAccountBalancing {
    ...
    public static int minTransfers(int[][] transactions) {
        ...
        Map<Integer, List<List<Integer>>> posMap = new HashMap<Integer, List<List<Integer>>>();
        Map<Integer, List<List<Integer>>> negMap = new HashMap<Integer, List<List<Integer>>>();
    ...
    public static int pairCount(List<Integer> pos, List<Integer> neg, List<Integer> posList, List<Integer> negList) {
        ...
        PriorityQueue<Integer> pospq = new PriorityQueue<Integer>(1, Collections.reverseOrder());
    ...
    public static void subsetSum(Map<Integer, List<List<Integer>>> res, List<Integer> lst) {
        if (lst.isEmpty()) {
    ...
    public static void main(String[] args) {
        ...
        int[][] a = { { 0, 6, 7 }, { 0, 7, 7 }, { 1, 4, 5 }, { 1, 5, 4 }, { 2, 5, 2 }, { 3, 7, 1 } };
